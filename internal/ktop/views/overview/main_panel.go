...
import (
	...
	"github.com/yourusername/z9s/application"
	"github.com/yourusername/z9s/k8s"
	"github.com/yourusername/z9s/metrics"
	"github.com/yourusername/z9s/ui"
	containerdetail "github.com/yourusername/z9s/views/container"
	"github.com/yourusername/z9s/views/model"
	nodedetail "github.com/yourusername/z9s/views/node"
	poddetail "github.com/yourusername/z9s/views/pod"
