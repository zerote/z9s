...
var Theme = struct {
	...
	// Header colors (matching k9s style)
	HeaderBackground:    "cadetblue",
	HeaderForeground:    "black",
	HeaderShortcutKey:   "aqua",     // Keyboard shortcut key color (like k9s)
	HeaderSortIndicator: "aqua",     // Sort arrow color
	...
	// Data display colors (k9s style)
	DataPrimary:   "aqua",
	DataSecondary: "cadetblue",
	DataHighlight: "aqua",

	// Graph/meter colors (k9s style)
	GraphLow:    "aqua",
	GraphMedium: "orange",
	GraphHigh:   "red",
	...
	// Resource usage thresholds and colors (k9s style)
	ResourceLowThreshold:    70.0,
	ResourceMediumThreshold: 90.0,
	ResourceHighThreshold:   100.0,
	ResourceLowColor:        "aqua",
	ResourceMediumColor:     "orange",
	ResourceHighColor:       "red",

	// Restart count thresholds and colors (k9s style)
	RestartsLowThreshold:    2,
	RestartsMediumThreshold: 9,
	RestartsHighThreshold:   10,
	RestartsLowColor:        "aqua",
	RestartsMediumColor:     "orange",
	RestartsHighColor:       "red",

	// Sparkline colors (k9s style)
	SparklineNormal:    "aqua",        // Normal/low usage (< 70%)
	SparklineMedium:    "orange",      // Medium usage (multi-line only)
	SparklineHigh:      "red",         // High usage (>= 70%)
	SparklineEmpty:     "gray",        // Zero/empty values
	SparklineThreshold: 0.70,          // 70% threshold for high color

	// Trend arrow colors (k9s style)
	TrendNormalColor:   "aqua",        // Normal trend arrows (matches table text)
